...
use serenity::{
    all::{
        ...
        IntegrationId, Interaction, InviteCreateEvent, InviteDeleteEvent, Member, Mentionable,
        Message, MessageId, MessageUpdateEvent, Presence, Role, RoleId, ScheduledEvent, Sticker,
        StickerId, UnavailableGuild, VoiceState,
    },
...
pub async fn voice_state_diff_str(
    ...
    new: &VoiceState,
    cache: Arc<impl serenity::all::CacheHttp>,
